...
import com.dio.devWeek.Repository.OcorrenciaRepository;
...
public class ControllerOcorrencias {
    private final OcorrenciaRepository ocRepository;

    public ControllerOcorrencias(OcorrenciaRepository ocRepository) {
